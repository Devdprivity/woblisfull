...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLoginLayout title="Iniciar Sesión" description="Ingresa tu email y contraseña para acceder">
            <Head title="Iniciar Sesión - Woblis" />

            {/* Status message */}
            {status && (
                <div className="mb-6 p-3 bg-green-500/20 border border-green-500/50 rounded-lg text-green-100 text-sm text-center">
                    {status}
                </div>
            )}
                ...
                <div className="grid gap-6">
                        ...
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink
                                    ...
                                    className="ml-auto text-sm text-[#7FFF00] hover:text-[#6FEF00]"
                                    tabIndex={5}
                                >
                    ...
                    <div className="flex items-center space-x-3">
                        <Checkbox
                            ...
                            tabIndex={3}
                            className="border-white/30 data-[state=checked]:bg-[#7FFF00] data-[state=checked]:border-[#7FFF00]"
                        />
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-black/40 px-2 text-gray-300 backdrop-blur-sm">O continúa con</span>
                        </div>
                    </div>
