...
export default function PostsEdit({ post }: Props) {
    ...
    const hasChanges = () => {
        return (
            ...
            formData.published_at !== (post.published_at ? post.published_at.slice(0, 16) : '')
        );
    };

    return (
        <AppLayout>
            <Head title={`Editar Post: ${post.title}`} />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-white">Actualiza la información del post</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2 text-sm">
                                ...
                                <div>
                                    <span className="font-medium">Creado:</span> {new Date(post.created_at).toLocaleDateString('es-ES')}
                                </div>
                                <div>
                                    <span className="font-medium">Actualizado:</span> {new Date(post.updated_at).toLocaleDateString('es-ES')}
                                </div>
                                {post.published_at && (
                                    <div>
                                        <span className="font-medium">Publicado:</span> {new Date(post.published_at).toLocaleDateString('es-ES')}
                                    </div>
                                )}
                            </CardContent>
                        </Card>
